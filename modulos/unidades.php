...
$aDat = array();
$aDat['modulo'] = 'unidades';
//$aDat['AccionAlLlenarReg'] = 'completaRegIndicadores(xml);';
//$aDat['TabEliminar'] = "0";
$aDat['aDlg'] = array('titulo'=>'Unidades','width'=>'770');

/*<!-- Agregar los campos para el filtro. el valor es con el formato SQL alias.campo -->*/
$aFiltroCampos = array();
$aFiltroCampos[] = array('valor'=>'u.id','etiqueta'=>'id');
$aFiltroCampos[] = array('valor'=>'u.descorta','etiqueta'=>'Descripcion Corta');
$aFiltroCampos[] = array('valor'=>'u.descripcion','etiqueta'=>'Descripcion');
...
$aDlgRenglones[] = array('atributos'=>array('id'=>'row_id_unidades','style'=>'visibility:visible;'),'columnas'=>$aDlgCol);
