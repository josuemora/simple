...
$config_apps['libs_js_url'][] = '/jsPDF/jspdf.min.js';
$config_apps['libs_js_url'][] = '/htmlcanvas/html2canvas.min.js';
...
$aApps[] = array ("appid"=>"App004","appdesc"=>"Métricos","appicon"=>"fas fa-chart-bar","modulos"=>array("areas","unidades","indicadores","registro","marcos","tablero_mex_1","tablero_col_1","resumen")); 
